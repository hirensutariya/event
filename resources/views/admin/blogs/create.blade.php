...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form action="{{route('admin.blogs.createsave')}}" id="blogadd" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Blog Name" class="form-control  required" name="name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="uploader">
                                        <input type="file" class="file-styled-primary required checkImageWidthHeight" id="image_url" name="image_url">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea  name="description" class="form-control required basic-example description"    placeholder="Enter Blog Description" id="description"></textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Blog Meta Title" class="form-control" name="meta_title">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Blog Meta Keywords" class="form-control" name="meta_keywords">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" placeholder="Enter Blog Meta Description" class="form-control" name="meta_description"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary waves-effect waves-light">Create New Blog</button>
            </div>
        </form>
    </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->