...
//        "dom": 'lftipr',
        "ajax": {
            "url": "{{route('events-collection-data')}}",
            "dataType": "json",
            "type": "POST",
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="float-right">
                            <a type="button" class="btn btn-outline-primary waves-effect waves-light ajaxviewmodel" href="{{route('admin.events.create')}}"><i class="icon-plus3"></i> Add New Events</a>
                        </div>
                        <h4  class="mt-0 header-title">Manage Events</h4>
                        <p class="sub-title">
